...
var eventsData = [{
        ...
        description: 'Film superhero terbaru dari Marvel Studios yang menghadirkan pertarungan epik antar multiverse.',
        poster_url: '',
        status: 'published',
        min_price: 75000,
        max_price: 150000,
        start_at: '2025-07-15T10:00:00',
        end_at: '2025-08-15T22:00:00',
    ...
    },
    {
        ...
        slug: 'kkn-di-desa-penari-2',
        description: 'Sequel horor terseram yang mengisahkan kelanjutan teror di desa misterius.',
        poster_url: '',
        status: 'published',
        min_price: 50000,
        max_price: 100000,
        start_at: '2025-06-20T10:00:00',
        end_at: '2025-07-20T22:00:00',
    ...
    },
    {
        ...
        description: 'Petualangan baru Spider-Man melintasi dimensi yang belum pernah terjamah.',
        poster_url: '',
        status: 'draft',
        min_price: 75000,
        max_price: 150000,
        start_at: '2025-08-01T10:00:00',
        end_at: '2025-09-01T22:00:00',
    ...
    },
    {
        ...
        title: 'Dilan 1991',
        slug: 'dilan-1991',
        description: 'Kisah cinta legendaris Dilan dan Milea yang kembali menghiasi layar lebar.',
        poster_url: '',
        status: 'completed',
        min_price: 35000,
        max_price: 75000,
        start_at: '2025-01-25T10:00:00',
        end_at: '2025-02-25T22:00:00',
    ...
    },
    {
        ...
        description: 'Film horor ikonik karya Joko Anwar yang siap menggelegarkan bioskop.',
        poster_url: '',
        status: 'draft',
        min_price: 50000,
        max_price: 100000,
        start_at: '2025-10-31T18:00:00',
        end_at: '2025-11-30T22:00:00',
    ...
    },
    {
        ...
        title: 'Inside Out 3',
        slug: 'inside-out-3',
        description: 'Petualangan emosi dalam pikiran kembali dengan cerita yang lebih menyentuh hati.',
        poster_url: '',
        status: 'published',
        min_price: 40000,
        max_price: 80000,
        start_at: '2025-06-15T10:00:00',
        end_at: '2025-07-15T22:00:00',
    ...
    },
    {
        ...
        title: 'John Wick 5',
        slug: 'john-wick-5',
        description: 'Aksi tak terhenti dari John Wick dalam misi terakhirnya.',
        poster_url: '',
        status: 'cancelled',
        min_price: 75000,
        max_price: 150000,
        start_at: '2025-05-10T10:00:00',
        end_at: '2025-06-10T22:00:00',
    ...
    },
    {
        ...
        category_id: 2,
        venue_ids: [1, 2, 5],
        title: 'Ada Apa dengan Cinta 3',
        slug: 'ada-apa-dengan-cinta-3',
        description: 'Kisah cinta Cinta dan Rangga yang melintasi waktu dan jarak.',
        poster_url: '',
        status: 'published',
        min_price: 35000,
        max_price: 75000,
        start_at: '2025-04-20T10:00:00',
        end_at: '2025-05-20T22:00:00',
    ...
    },
    {
        ...
        title: 'Alien: Earth',
        slug: 'alien-earth',
        description: 'Ancaman alien yang mengancam bumi dalam film fiksi ilmiah yang menegangkan.',
        poster_url: '',
        status: 'draft',
        min_price: 75000,
        max_price: 150000,
        start_at: '2025-09-12T10:00:00',
        end_at: '2025-10-12T22:00:00',
    ...
    },
    {
        ...
        slug: 'kung-fu-panda-5',
        description: 'Po si panda lucu kembali dalam petualangan bela diri yang seru dan mengharukan.',
        poster_url: '',
        status: 'completed',
        min_price: 40000,
        max_price: 80000,
        start_at: '2025-03-08T10:00:00',
        end_at: '2025-04-08T22:00:00',
    ...
    },
    {
        ...
        slug: 'fast-and-furious-11',
        description: 'Aksi balap liar dan misi penyelamatan dunia yang memacu adrenalin.',
        poster_url: '',
        status: 'published',
        min_price: 60000,
        max_price: 120000,
        start_at: '2025-07-04T10:00:00',
        end_at: '2025-08-04T22:00:00',
    ...
    },
    {
        ...
        title: 'The Batman 2',
        slug: 'the-batman-2',
        description: 'Kejahatan baru mengancam Gotham, Batman harus menghadapi musuh terberatnya.',
        poster_url: '',
        status: 'draft',
        min_price: 75000,
        max_price: 150000,
        start_at: '2025-11-15T10:00:00',
        end_at: '2025-12-15T22:00:00',
...
function setActiveNav(el) {
    ...
    showToast('Navigasi ke: ' + el.querySelector('span').textContent, 'var(--accent)');
}
...
function applyFilter() {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        if (!e) {
            rows[i].setAttribute('data-matches', '0');
            continue;
        }
...
function submitForm() {
    ...
    if (!slug) {
        document.getElementById('errSlug').classList.add('visible');
        valid = false;
    }
    if (!category) {
    ...
    if (venueIds.length === 0) {
        document.getElementById('errVenue').classList.add('visible');
        valid = false;
    }
    if (!minPrice || parseInt(minPrice) < 0) {
        document.getElementById('errMinPrice').classList.add('visible');
        valid = false;
    }
    if (!maxPrice || parseInt(maxPrice) < 0) {
        document.getElementById('errMaxPrice').classList.add('visible');
        valid = false;
    }
    if (!startAt) {
        document.getElementById('errStartAt').classList.add('visible');
        valid = false;
    }
    if (!endAt) {
        document.getElementById('errEndAt').classList.add('visible');
        valid = false;
    }
...
function confirmDelete() {
    ...
    if (e) {
        var title = e.title;
        eventsData = eventsData.filter(function (item) {
...
function handleResize() {
    document.getElementById('statsGrid').style.gridTemplateColumns = window.innerWidth < 768 ? 'repeat(2,1fr)' : 'repeat(4,1fr)';
}
